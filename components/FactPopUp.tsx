  ...
  return (
    <div className="fixed bottom-10 right-10 w-96 bg-[var(--bg)] border border-slate-500/10 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] z-50 animate-in slide-in-from-bottom-6 duration-500 rounded-[3rem] overflow-hidden backdrop-blur-xl">
      <div className="bg-slate-900 p-8 flex justify-between items-center text-white">
        <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-primary">Сурагчийн өдрийн үг</span>
      ...
      <div className="p-12 flex gap-10 text-left items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-between py-2">
          <div className="space-y-8">
            <div>
              <span className="text-[10px] font-bold text-secondary uppercase tracking-[0.3em]">{data?.language} Гарал үүсэл</span>
              <p className="text-[10px] font-bold opacity-30 italic mt-2 uppercase tracking-widest">Дуудлага: {data?.pronunciation}</p>
            </div>
            <div className="space-y-6">
              <div className="text-xl font-serif uppercase tracking-tight leading-tight">
                Утга: <span className="text-primary">{data?.translation}</span>
              </div>
          ...
          <div className="pt-8 border-t border-slate-500/10">
             <div className="text-[8px] font-bold opacity-30 uppercase tracking-[0.4em]">Анир сурагчдад зориулсан өдөр тутмын ойлголт</div>
          </div>
        </div>
      </div>
    </div>
